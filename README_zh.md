...
- [`trafficlight4ai-0.3.0-windows-amd64.zip`](https://github.com/yhz61010/trafficlight4ai/releases/download/v0.3.0/trafficlight4ai-0.3.0-windows-amd64.zip) — Windows 构建，已通过 `windeployqt` 打包 Qt 运行库。
- [`trafficlight4ai-0.3.0-linux-amd64.deb`](https://github.com/yhz61010/trafficlight4ai/releases/download/v0.3.0/trafficlight4ai-0.3.0-linux-amd64.deb) — Ubuntu/Debian 安装包。
- [`trafficlight4ai-0.3.0-fedora-amd64.rpm`](https://github.com/yhz61010/trafficlight4ai/releases/download/v0.3.0/trafficlight4ai-0.3.0-fedora-amd64.rpm) — Fedora 安装包。
