...
- [`trafficlight4ai-1.0.1-windows-amd64.zip`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-windows-amd64.zip) — Windows build with Qt runtime files bundled by `windeployqt`.
- [`trafficlight4ai-1.0.1-linux-amd64.deb`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-linux-amd64.deb) — Ubuntu/Debian package.
- [`trafficlight4ai-1.0.1-fedora-amd64.rpm`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-fedora-amd64.rpm) — Fedora package.
- [`trafficlight4ai-1.0.1-opensuse-amd64.rpm`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-opensuse-amd64.rpm) — openSUSE Leap package.
- [`trafficlight4ai-1.0.1-arch-amd64.pkg.tar.zst`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-arch-amd64.pkg.tar.zst) — Arch Linux package.
- [`trafficlight4ai-1.0.1-linux-amd64.AppImage`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-linux-amd64.AppImage) — generic Linux AppImage.
- [`trafficlight4ai-1.0.1-macos-arm64.zip`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/trafficlight4ai-1.0.1-macos-arm64.zip) — macOS arm64 app bundle with Qt frameworks.
- [`SHA256SUMS.txt`](https://github.com/yhz61010/trafficlight4ai/releases/download/v1.0.1/SHA256SUMS.txt) — checksums for release archives.
