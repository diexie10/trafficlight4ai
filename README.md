...
- [`trafficlight4ai-0.3.0-windows-amd64.zip`](https://github.com/yhz61010/trafficlight4ai/releases/download/v0.3.0/trafficlight4ai-0.3.0-windows-amd64.zip) — Windows build with Qt runtime files bundled by `windeployqt`.
- [`trafficlight4ai-0.3.0-linux-amd64.deb`](https://github.com/yhz61010/trafficlight4ai/releases/download/v0.3.0/trafficlight4ai-0.3.0-linux-amd64.deb) — Ubuntu/Debian package.
- [`trafficlight4ai-0.3.0-fedora-amd64.rpm`](https://github.com/yhz61010/trafficlight4ai/releases/download/v0.3.0/trafficlight4ai-0.3.0-fedora-amd64.rpm) — Fedora package.
